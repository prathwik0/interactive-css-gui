...
<div class="flex justify-between">
	<div class="flex flex-wrap flex-grow p-3">
...
<div class="flex flex-wrap gap-2 my-2">
	<!-- <CSSPropertySlider property="width" bind:selectedValue={adjusting.currentBox.boxModel['width'].numeric.num} />
	<CSSPropertySlider property="height" bind:selectedValue={adjusting.currentBox.boxModel['height'].numeric.num} />
	<CSSPropertySlider property="border" bind:selectedValue={adjusting.currentBox.boxModel['border'].numeric.num} />
	<CSSPropertySlider property="margin" bind:selectedValue={adjusting.currentBox.boxModel['margin'].numeric.num} />
	<CSSPropertySlider property="padding" bind:selectedValue={adjusting.currentBox.boxModel['padding'].numeric.num} /> -->
